...
import org.thingsboard.server.service.entity.device.TbClaimDeviceService;
...
public class DeviceController extends BaseController {
    ...
    public DeferredResult<ResponseEntity> claimDevice(@ApiParam(value = "Unique name of the device which is going to be claimed")
        ...
        ListenableFuture<ClaimResult> future = tbClaimDeviceService.claimDevice(tenantId, device, customerId, secretKey, user);
    ...
    public DeferredResult<ResponseEntity> reClaimDevice(@ApiParam(value = "Unique name of the device which is going to be reclaimed")
        ...
        ListenableFuture<ReclaimResult> result = tbClaimDeviceService.reclaimDevice(tenantId, device, user);
